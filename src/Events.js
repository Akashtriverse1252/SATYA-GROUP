...
export const Events = ({ match }) => {
  ...
  const loadData = async () => {
     const response = await axios.get(`https://www.satyagroups.in/api/events.php?y=${slug}`);
     if(mounted){
                  ...
                  <TabPanel>
                    ...
                    {galleryData.galData.map(galData => (
                        <div className='eventsbox'>
                            <NavLink to={'/event/' + galData.yearData + '/' + galData.monthData + '/' + galData.news_paperName}>
