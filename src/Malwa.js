...
import Banner from './images/malwa-county-banner.jpg'
import Logo from './images/malwa-county-logo.png'
...
import Amenities04 from './images/tennis-lawn.png'
import Amenities05 from './images/squash-court.png'
import Amenities06 from './images/gym.png'
import Amenities07 from './images/jogging-track.png'
import Amenities08 from './images/badminton-court.png'
import Gallery01 from './images/malwa-county-01.jpg'
import Gallery02 from './images/malwa-county-02.jpg'
import Gallery03 from './images/malwa-county-03.jpg'
import Gallery04 from './images/malwa-county-04.jpg'
import Gallery05 from './images/malwa-county-05.jpg'
import Gallery06 from './images/malwa-county-06.jpg'
import Gallery07 from './images/malwa-county-07.jpg'
import Locationimg from './images/malwa-county-location.jpg'
  ...
  return (
    <>
            ...
            <div className='container'>
                <div className='row'>
                    <div className='web-container'>
                            ...
                            <h1 data-aos="zoom-in" data-aos-offset="200" data-aos-duration="600" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300">The perfect place to call home</h1>
                                <p data-aos="fade-in" data-aos-offset="200" data-aos-duration="600" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300">Malwa County is a self-contained integrated residential township spread over 100 acres of prime real estate, located strategically on AB Bypass road, Indore. It is a vibrant mix of residential, commercial and institutional infrastructure. </p>
                            </div>
                            <div className='pprojecthighlights'>
                                <ul data-aos="fade-up" data-aos-offset="200" data-aos-duration="500" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300">
                                    ...
                                    <li ><strong>Location   </strong><span>Bypass Road, Indore</span></li>
                                </ul>
                            </div>
                            </div>
                    </div>
        ...
        <div className='amenitiesrow'>
            ...
            <h3 data-aos="zoom-in" data-aos-offset="200" data-aos-duration="600" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300">malwa county facilities</h3>
                <ul>
                    ...
                    <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="600" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300"><span><img src={Amenities02} /></span><p>Community center </p></li>
                    ...
                    <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="800" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300"><span><img src={Amenities04} /></span><p>Tennis lawn  </p></li>
                    <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="900" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300"><span><img src={Amenities05} /></span><p>Squash court</p></li>
                    <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="900" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300"><span><img src={Amenities06} /></span><p>Modern gymnasium</p></li>
                    <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="900" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300"><span><img src={Amenities07} /></span><p>Jogging trail </p></li>
                    <li data-aos="fade-up" data-aos-offset="200" data-aos-duration="900" data-aos-once="true" data-aos-easing="ease-in-sine" data-aos-delay="300"><span><img src={Amenities08} /></span><p>Badminton court </p></li>
                </ul>
            </div>            
            </div>
                </div>
